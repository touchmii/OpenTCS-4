 ...
 */
package org.opentcs.kernel.extensions.websockets.servicewebsocketsapi;
...
import org.opentcs.kernel.extensions.websockets.servicewebsocketsapi.v1.V1RequestHandler;
import org.opentcs.kernel.extensions.websockets.servicewebsocketsapi.v1.V1RequestHandlerWebSockets;
 ...
 */
public class ServiceWebSocketApi
    implements KernelExtension {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(ServiceWebSocketApi.class);
  /**
   ...
   */
  @Inject
  public ServiceWebSocketApi(ServiceWebApiConfiguration configuration,
  ...
  public void initialize() {
    if (isInitialized()) {
      ...
      Spark.webSocket("/api/v1", this.v1RequestHandler);
