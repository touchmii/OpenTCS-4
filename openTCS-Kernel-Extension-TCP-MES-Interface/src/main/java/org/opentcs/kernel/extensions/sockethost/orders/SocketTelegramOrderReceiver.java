 ...
 */
public class SocketTelegramOrderReceiver
    implements KernelExtension {

  /**
   * This class's Logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(SocketTelegramOrderReceiver.class);
  /**
   ...
   */
  @Inject
  public SocketTelegramOrderReceiver(TransportOrderService transportOrderService,
...
//      LOG.debug()
      ...
      if (telegram.contains("Oorder-")) {
        ...
        transport.setDeadline(Date.from(Instant.now().plus(60, ChronoUnit.MINUTES)));
