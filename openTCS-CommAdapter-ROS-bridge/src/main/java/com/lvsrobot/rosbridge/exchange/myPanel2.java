...
//    private final DefaultListModel<OrderRequest> lastOrderListModel = new DefaultListModel<>();
    ...
    private ROSBridgeProcessModelTO processModel;

    @Inject
    public myPanel2(@Assisted ROSBridgeProcessModelTO processModel,
    ...
    public void processModelChange(String attributeChanged, VehicleProcessModelTO newProcessModel) {
        if(!(newProcessModel instanceof ROSBridgeProcessModelTO)) {
            return;
        }

        processModel = (ROSBridgeProcessModelTO) newProcessModel;
    ...
    private void updateExampleVehicleModelData(String attributeChanged,
                                               ROSBridgeProcessModelTO processModel) {
