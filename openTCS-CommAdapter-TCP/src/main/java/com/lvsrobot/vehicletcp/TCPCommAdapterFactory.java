...
public class TCPCommAdapterFactory implements VehicleCommAdapterFactory {

    /**
     * This class's Logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger(TCPCommAdapterFactory.class);
     ...
     */
    @Inject
    public TCPCommAdapterFactory(TCPAdapterComponentsFactory componentsFactory) {
    ...
    public VehicleCommAdapterDescription getDescription() {
        return new TCPCommAdapterDescription();
    }
