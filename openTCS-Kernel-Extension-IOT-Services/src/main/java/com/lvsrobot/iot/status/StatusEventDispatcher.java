...
import com.lvsrobot.iot.ServiceIotConfiguration;
import com.lvsrobot.iot.status.binding.OrderStatusMessage;
import com.lvsrobot.iot.status.binding.StatusMessage;
import com.lvsrobot.iot.status.binding.StatusMessageList;
import com.lvsrobot.iot.status.binding.VehicleStatusMessage;
...
public class StatusEventDispatcher
   ...
   */
  private final ServiceIotConfiguration configuration;
  /**
  ...
  @Inject
  public StatusEventDispatcher(ServiceIotConfiguration configuration,
