...
import com.lvsrobot.rosbridge.ROSBridgeCommAdapterDescription;
 ...
 */
public class ROSBridgeCommAdapterPanelFactory
    implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(ROSBridgeCommAdapterPanelFactory.class);
  /**
   * The service portal.
   */
   ...
   */
  @Inject
  public ROSBridgeCommAdapterPanelFactory(KernelServicePortal servicePortal,
  ...
  public List<VehicleCommAdapterPanel> getPanelsFor(
    ...
    panels.add(componentsFactory.createmyPanel2((ROSBridgeProcessModelTO) processModel,
...
//                                                   servicePortal.getVehicleService()));
  ...
  private boolean providesPanelsFor(VehicleCommAdapterDescription description,
    ...
    return (description instanceof ROSBridgeCommAdapterDescription)
        && (processModel instanceof ROSBridgeProcessModelTO);
  }
}
