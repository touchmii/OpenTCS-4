...
/**
 * A custom model for the {@link ROSBridgeCommAdapter} which holds additional information
 * about the connected vehicle.
 *
 * @author Mats Wilhelm (Fraunhofer IML)
 */
public class ROSBridgeProcessModel extends VehicleProcessModel implements VelocityListener {
    /**
    ...
    public ROSBridgeProcessModel(Vehicle attachedVehicle) {
