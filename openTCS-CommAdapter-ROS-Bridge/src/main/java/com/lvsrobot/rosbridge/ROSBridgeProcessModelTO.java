...
/**
 * A serializable representation of a {@link ROSBridgeProcessModel}.
 ...
 */
public class ROSBridgeProcessModelTO extends VehicleProcessModelTO {
    /**
    ...
    public ROSBridgeProcessModelTO setSingleStepModeEnabled(boolean singleStepModeEnabled) {
    ...
    public ROSBridgeProcessModelTO setLoadOperation(String loadOperation) {
    ...
    public ROSBridgeProcessModelTO setUnloadOperation(String unloadOperation) {
    ...
    public ROSBridgeProcessModelTO setOperatingTime(int operatingTime) {
    ...
    public ROSBridgeProcessModelTO setMaxAcceleration(int maxAcceleration) {
    ...
    public ROSBridgeProcessModelTO setMaxDeceleration(int maxDeceleration) {
    ...
    public ROSBridgeProcessModelTO setMaxFwdVelocity(int maxFwdVelocity) {
    ...
    public ROSBridgeProcessModelTO setMaxRevVelocity(int maxRevVelocity) {
    ...
    public ROSBridgeProcessModelTO setVehiclePaused(boolean vehiclePaused) {
