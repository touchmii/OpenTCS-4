...
import org.swingexplorer.internal.FrmSwingExplorer;
import org.swingexplorer.internal.LookAndFeelsComboBox;
...
class ControlBar
	extends JPanel
{
	private static FrmSwingExplorer frame;
	...
	void initialize( FrmSwingExplorer frame, JTabbedPane tabbedPane ) {
		this.frame = frame;
	...
	public static void selectLookAndFeel( String lafClassName ) {
	...
	private static LookAndFeelsComboBox lookAndFeelComboBox;
