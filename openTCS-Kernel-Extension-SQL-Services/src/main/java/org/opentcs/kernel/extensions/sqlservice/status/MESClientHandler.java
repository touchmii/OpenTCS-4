...
public class MESClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ...
        println("Connected to MES : " + ctx.channel().remoteAddress());
...
//        if (e.state() == IdleState.READER_IDLE) {
    ...
    public void channelInactive(final ChannelHandlerContext ctx) {
        println("Disconnected MES from: " + ctx.channel().remoteAddress());
    }

    @Override
    public void channelUnregistered(final ChannelHandlerContext ctx) throws Exception {
        println("Sleeping for: " + StatusMessageDispatcher.RECONNECT_DELAY + 's');
