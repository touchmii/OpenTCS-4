...
import org.opentcs.kernel.extensions.sqlservice.status.binding.OrderStatusMessage;
import org.opentcs.kernel.extensions.sqlservice.status.binding.StatusMessage;
import org.opentcs.kernel.extensions.sqlservice.status.binding.TCSStatusMessageSet;
import org.opentcs.kernel.extensions.sqlservice.status.binding.VehicleStatusMessage;
...
//      sendMessage(VehicleStatusMessage.fromVehicle((Vehicle) eventObject), writer);
  ...
  private void sendJson(StatusMessage message, Writer writer) throws IOException {
